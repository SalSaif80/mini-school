    ...
    <div class="nav-item mt-3">
        <div class="d-flex align-items-center">
            ...
            @if (Auth::user()->google2fa_secret)
                <a class="nav-link text-danger ps-0" href="{{ route('2fa.disable.form') }}">
                    تعطيل التحقق بخطوتين
                    <span class="badge bg-success ms-2">مفعل</span>
                </a>
            @else
                <a class="nav-link text-success ps-0" href="{{ route('2fa.setup') }}">
                    تفعيل التحقق بخطوتين
                    <span class="badge bg-secondary ms-2">غير مفعل</span>
                </a>
            @endif
        </div>
    </div>
